...
sed -i 's/10.68.156.11/10.0.2.111/g' \
        ku8_install/harbor_install/harbor/harbor.cfg \
        ku8_install/harbor_install/harbor/harbor.cfg
sed -i 's/10.68.156.10:1389/10.0.2.111:1389 /g' \
        ku8_install/harbor_install/harbor/harbor.cfg \
        ku8_install/harbor_install/harbor/harbor.cfg
